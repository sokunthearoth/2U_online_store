...
export default function Boy() {
    ...
    const match1 = products.boy_shirts.some(item => item.name.includes(search));
    const match2 = products.boy_pants.some(item => item.name.includes(search));
    return (
        <div>
            ...
            <div className={styles.product_girl}>
                ...
                <div className={styles.Girl}>
                    ...
                    <div className={styles.product}>
                        {issearch && sort === "d" && select === 'boy_shirts' && products.boy_shirts.filter(item => item.name.toLowerCase().includes(search)).map((product, index) => {
                            return (
                        ...
                        {!issearch && sort === "lh" && select === 'boy_shirts' && products.boy_shirts.filter(item => item.name.toLowerCase().includes(search)).sort((a, b) => a.price - b.price).map((product, index) => {
                            return (
                                <div className={styles.img}>
                                    <Image key={index} onclick={() => addcart(product)} src={product.url} title={product.name} price={product.price} />
                                </div>
                        ...
                        {!issearch && sort === "hl" && select === 'boy_shirts' && products.boy_shirts.filter(item => item.name.toLowerCase().includes(search)).sort((a, b) => b.price - a.price).map((product, index) => {
                            return (
                                <div className={styles.img}>
                                    <Image key={index} onclick={() => addcart(product)} src={product.url} title={product.name} price={product.price} />
                                </div>
                        ...
                        {issearch && sort === "d" && select === 'boy_pants' && products.boy_pants.filter(item => item.name.toLowerCase().includes(search)).map((product, index) => {
                            return (
                                <div className={styles.img}>
                                    <Image key={index} onclick={() => addcart(product)} src={product.url} title={product.name} price={product.price} />
                                </div>
                        ...
                        {!issearch && sort === "lh" && select === 'boy_pants' && products.boy_pants.filter(item => item.name.toLowerCase().includes(search)).sort((a, b) => a.price - b.price).map((product, index) => {
                            return (
                                <div className={styles.img}>
                                    <Image key={index} onclick={() => addcart(product)} src={product.url} title={product.name} price={product.price} />
                                </div>
                        ...
                        {!issearch && sort === "hl" && select === 'boy_pants' && products.boy_pants.filter(item => item.name.toLowerCase().includes(search)).sort((a, b) => b.price - a.price).map((product, index) => {
                            return (
                                <div className={styles.img}>
                                    <Image key={index} onclick={() => addcart(product)} src={product.url} title={product.name} price={product.price} />
                                </div>
