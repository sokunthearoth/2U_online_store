...
export default function Skincare() {
    ...
    const match4 = products.skin_cares.some(item => item.name.includes(search));
    return (
        <div>
            ...
            <div className={styles.product_girl}>
                ...
                <div className={styles.Girl}>
                    ...
                    <div className={styles.product}>
                        {issearch && sort === "d" && select === 'skin_cares' && products.skin_cares.filter(item => item.name.toLowerCase().includes(search)).map((product, index) => {
                            return (
                        ...
                        {!issearch && sort === "lh" && select === 'skin_cares' && products.skin_cares.filter(item => item.name.toLowerCase().includes(search)).sort((a, b) => a.price - b.price).map((product, index) => {
                            return (
                                <div className={styles.img}>
                                    <Image key={index} onclick={() => addcart(product)} src={product.url} title={product.name} price={product.price} />
                                </div>
                        ...
                        {!issearch && sort === "hl" && select === 'skin_cares' && products.skin_cares.filter(item => item.name.toLowerCase().includes(search)).sort((a, b) => b.price - a.price).map((product, index) => {
                            return (
                                <div className={styles.img}>
                                    <Image key={index} onclick={() => addcart(product)} src={product.url} title={product.name} price={product.price} />
                                </div>
